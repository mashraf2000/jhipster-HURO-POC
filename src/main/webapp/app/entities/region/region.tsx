...
export const Region = (props: IRegionProps) => {
  ...
  const { regionList, match, totalItems } = props;
  return (
    <div>
      <h2 id="region-heading">
        <Translate contentKey="huroPocApp.region.home.title">Regions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="huroPocApp.region.home.createLabel">Create new Region</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {regionList && regionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('regionName')}>
                  <Translate contentKey="huroPocApp.region.regionName">Region Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="huroPocApp.region.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="huroPocApp.region.home.notFound">No Regions found</Translate>
          </div>
        )}
      </div>
