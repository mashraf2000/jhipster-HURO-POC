...
export const Country = (props: ICountryProps) => {
  ...
  const { countryList, match, totalItems } = props;
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="huroPocApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="huroPocApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {countryList && countryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('countryName')}>
                  <Translate contentKey="huroPocApp.country.countryName">Country Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="huroPocApp.country.home.notFound">No Countries found</Translate>
          </div>
        )}
      </div>
