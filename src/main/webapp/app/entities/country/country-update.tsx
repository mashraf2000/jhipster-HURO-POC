...
export const CountryUpdate = (props: ICountryUpdateProps) => {
  ...
  const { countryEntity, compliances, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="huroPocApp.country.home.createOrEditLabel">
            <Translate contentKey="huroPocApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="countryNameLabel" for="country-countryName">
                  <Translate contentKey="huroPocApp.country.countryName">Country Name</Translate>
                </Label>
