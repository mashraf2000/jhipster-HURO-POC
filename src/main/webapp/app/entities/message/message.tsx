...
export const Message = (props: IMessageProps) => {
  ...
  const { messageList, match, totalItems } = props;
  return (
    <div>
      <h2 id="message-heading">
        <Translate contentKey="huroPocApp.message.home.title">Messages</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="huroPocApp.message.home.createLabel">Create new Message</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {messageList && messageList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('subject')}>
                  <Translate contentKey="huroPocApp.message.subject">Subject</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('body')}>
                  <Translate contentKey="huroPocApp.message.body">Body</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('dateCreated')}>
                  <Translate contentKey="huroPocApp.message.dateCreated">Date Created</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('dateUpdated')}>
                  <Translate contentKey="huroPocApp.message.dateUpdated">Date Updated</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {messageList.map((message, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{message.body}</td>
                  <td>
                    <TextFormat type="date" value={message.dateCreated} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={message.dateUpdated} format={APP_DATE_FORMAT} />
                  </td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="huroPocApp.message.home.notFound">No Messages found</Translate>
          </div>
        )}
      </div>
